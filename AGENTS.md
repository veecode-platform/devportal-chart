...
| .github/actions/test-charts/action.yml | Runs a throwaway PostgreSQL and the veecode-runtime-secrets Secret in the devportal-ci namespace and installs charts/backstage there. | The upstream action relies on the PostgreSQL subchart; keep this step after a resync, since the devportal chart disables that subchart. |
